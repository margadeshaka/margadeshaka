...
export const posts: BlogPost[] = [
  {
    ...
    excerpt:
      `Why overanalysing every word turns into a loop you never get out of, how an overthinking mind differs from a problem solving one, and six things you can do to break the cycle.`,
    category: 'Wellness',
    date: 'August 26, 2026',
    isoDate: '2026-08-26',
    readTime: '6 min read',
    ...
    body: [
      { type: 'p', text: `Overthinking has become a common thing nowadays to the extent that people have normalised it, but there is so much exhaustion in overanalysing every word and action that it becomes a loop you get stuck in. You never arrive at a conclusion. It slowly starts to become a habit without you realizing it and many people mistake it for a personality trait. And now you must be wondering how to stop overthinking and break the loop? Well, that is exactly what we are going to discuss in this blog.` },
      { type: 'p', text: `When one thing or thought becomes repetitive it is known as overthinking. Normal thinkers address a certain thought and let it go but overthinkers on the other hand cannot simply let go. They analyse everything but that comes from worry and fear only. That analysis is never healthy and it is not productive.` },
      { type: 'p', text: `The cycle goes on like they come with a thought rooted in fear or worry, they get anxious over it, analyse it, more uncertainty occurs and thus more constant thoughts. The questions never stop. What if I made the wrong decision? What if they judge me? What if this does not work out? The answers will never come when thinking from fear or anxiety.` },
      { type: 'h2', text: `Why do we overthink?` },
      { type: 'p', text: `Overthinking often comes from the fear of losing control and the fear of uncertainty. Everyone wants to take control but there are certain things that are out of our hands and sometimes everyone should simply accept that. There are certain reasons for overthinking:` },
      { type: 'p', text: `● Past traumas` },
      { type: 'p', text: `● Fear of failure` },
      { type: 'p', text: `● Fear of judgement` },
      { type: 'p', text: `● Always imagining worst case scenarios` },
      { type: 'p', text: `● Always worrying about making decisions` },
      { type: 'p', text: `● Focusing too much on past or future` },
      { type: 'p', text: `● Emotionally overwhelmed` },
      { type: 'p', text: `● Low self esteem` },
      { type: 'h2', text: `Signs that you are overthinking` },
      { type: 'p', text: `● Being impulsive when making decisions` },
      { type: 'p', text: `● Mentally tired or exhausted` },
      { type: 'p', text: `● Always imagining worst case possible` },
      { type: 'p', text: `● Not able to sleep properly due to running thoughts` },
      { type: 'p', text: `● Always second guessing yourself` },
      { type: 'p', text: `● Asking for reassurance` },
      { type: 'p', text: `● Afraid to make mistakes` },
      { type: 'p', text: `● Not able to take the first step` },
      { type: 'h2', text: `Overthinking vs Problem-Solving` },
      { type: 'p', text: `Now a lot of people have misconceptions that their ability to overthink and analyse is a problem solving ability but that is not correct. A problem solving mind thinks they have a problem and what can they really do about it? But an overthinking mind gets stuck in a constant loop of I have a problem and what if it all goes wrong? It will only think about negative outcomes whereas the problem solving mind is always in a neutral state.` },
      { type: 'p', text: `When you are overthinking about a problem you will always feel fear and anxiety but when you actually solve a problem you will feel calm or neutral, you will not worry over it. A problem-solving mind will lead to action whereas an overthinking mind will not take action from fear.` },
      { type: 'h2', text: `How to Stop Overthinking` },
      { type: 'h2', text: `1. Stop believing every thought` },
      { type: 'p', text: `If a thought is constant in your mind that does not mean it is true also, it has power on you only when you give it. If you simply let the thought come and go like a passing train and just observe it, it has no power over you. So next time a negative thought crosses your mind simply say “it is just a thought and it is not true.”` },
      { type: 'h2', text: `2. Distinguish facts and assumptions` },
      { type: 'p', text: `A lot of us have a habit of making assumptions when we are overthinking and anxious and that makes it difficult to break the loop of overthinking. So to stop overthinking next time ask yourself which of the statements are actually true? And which of them are just assumptions? This simple exercise gives your mind clarity at that moment.` },
      { type: 'h2', text: `3. Set your time to overthink` },
      { type: 'p', text: `Now you might think in what world is this healthy to set time to overthink? But instead of overthinking all day, you can simply set a time limit for yourself to overthink as much as you can and then just stop when the time is over. This slowly develops a habit of overthinking for a small amount of time to no overthinking at all.` },
      { type: 'h2', text: `4. Make a list of things you can control and things you cannot control` },
      { type: 'p', text: `Now this will sound silly to some but the actual difference happens when you actually make that list. Now after you make the list you remind yourself that for the things in your control are already in control so there is nothing to worry about and for the things out of your control are the things you cannot do anything about so why worry about them?` },
      { type: 'h2', text: `5. Talk it all out` },
      { type: 'p', text: `To stop overthinking some people literally talk it all out. Sometimes we are not able to see things clearly as we are blinded with negative thoughts and it is always better to say everything on your mind to your trusted people. Talking out your feelings always gives huge relief. Even if you do not have [someone to talk to](/blog/i-need-someone-to-talk-to/), try apps where you can talk to companions.` },
      { type: 'h2', text: `6. Pen down your thoughts` },
      { type: 'p', text: `This hack is literally magic to stop overthinking. When you freely pen down your feelings on a paper you actually feel like you told it to an actual person. You can even examine them later with a clear state of mind.` },
      { type: 'h2', text: `When you need help understanding yourself` },
      { type: 'p', text: `Sometimes being self aware is not enough, you know all the patterns and still can't break the loop. And as humans we need help and it is okay to do so.` },
      { type: 'p', text: `And if the worry has become constant and hard to control, that is worth taking seriously. According to the World Health Organization, [anxiety disorders are the most common mental disorders in the world](https://www.who.int/news-room/fact-sheets/detail/anxiety-disorders). They respond well to treatment, and yet only about one in four people affected ever receive any.` },
      { type: 'p', text: `This is where a space to reflect and break the loop helps.` },
      { type: 'p', text: `[Sakha](/#products) is a companion designed to help in those moments. It helps you explore your thoughts and emotions and provide you clarity. Instead of telling you to stop overthinking, it helps you take a breath and slow down in the present. It is a private and judgement free space. When you are stuck in a loop, Sakha helps you see things from other perspectives. It helps you feel understood.` },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: `Sakha is an AI companion built for days like this. Instead of rushing to give you answers, it helps you understand yourself, think clearly and move forward. Your conversations are encrypted, there is no fear of being judged, and [what you share stays private](/blog/privacy-first-ai/).` },
      { type: 'h2', text: `Conclusion` },
