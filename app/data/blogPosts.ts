...
export const posts: BlogPost[] = [
  {
    ...
    body: [
      ...
      { type: 'h2', text: `Why do we need guidance, in a world where the King of Kings can be spoken to?` },
      { type: 'p', text: `The use of technology has made the lives of people easy.` },
      { type: 'p', text: `AI is able to answer questions.` },
      { type: 'p', text: `Search engines are able to return millions of results.` },
      { type: 'p', text: `There are thousands of points of view possible in social media.` },
      { type: 'p', text: `But none of these get a grasp on your own values, goals, experiences or aspirations.` },
      { type: 'p', text: `Now the question is what connection does Knowledge have to your life?` },
      { type: 'p', text: `That is the reason why most people only look for mentors, coaches, communities and well thought out platforms — and not more information. They do not require additional answers.` },
