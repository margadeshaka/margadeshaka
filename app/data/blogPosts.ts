...
export const posts: BlogPost[] = [
  {
    ...
    body: [
      ...
      { type: 'p', text: `Try talking to someone you trust. Sometimes you don't need advice, just a place to let it all out. Start with a low-effort conversation with a loved one today. And if it feels like [you have no one to talk to](/blog/i-need-someone-to-talk-to), that feeling is far more common than you think, and there are ways through it.` },
      { type: 'h2', text: `How Sakha can help` },
      { type: 'p', text: `Sometimes you simply need a place to let everything out, and that is exactly what [Sakha](/#products) is for. Sakha is an AI companion for the days when you feel lost and empty and don't know where to go or what to do. These feelings often arrive at unusual hours, when everyone you know is asleep, and in those moments Sakha is there. There is no judgement, no timetable, and [what you share stays yours](/blog/privacy-first-ai). You don't need to figure everything out at once, and it is completely human to feel this way.` },
